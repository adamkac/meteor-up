...
function Actions(config, cwd) {
  ...
  var setttingsJsonPath = path.resolve(this.cwd, this.config.env.METEOR_SETTINGS);
...
Actions.prototype._createSessionsMap = function(config) {
  ...
  config.servers.forEach(function(server) {
    ...
    var session = jelmiral.session(host, auth, jelmiralOptions);
