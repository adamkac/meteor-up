...
exports.setup = function(installMongo, setupNode, nodeVersion, setupPhantom, appName) {
  var taskList = jelmiral.taskList('Setup (sunos)');
...
exports.deploy = function(bundlePath, env, deployCheckWaitTime, appName) {
  var taskList = jelmiral.taskList("Deploy app '" + appName + "' (sunos)");
...
exports.reconfig = function(env, appName) {
  var taskList = jelmiral.taskList("Updating configurations (sunos)");
...
exports.restart = function(appName) {
  var taskList = jelmiral.taskList("Restarting Application (sunos)");
...
exports.stop = function(appName) {
  var taskList = jelmiral.taskList("Stopping Application (sunos)");
...
exports.start = function(appName) {
  var taskList = jelmiral.taskList("Starting Application (sunos)");
