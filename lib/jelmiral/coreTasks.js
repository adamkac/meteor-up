module.exports = function(jelmiral) {
  jelmiral.registerTask('copy', copy);
  jelmiral.registerTask('execute', execute);
  jelmiral.registerTask('executeScript', executeScript);
  jelmiral.registerTask('print', print);
};
